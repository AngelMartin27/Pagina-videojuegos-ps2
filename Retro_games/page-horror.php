...
<main class="categoria-container">
  <div class="contenido-container">
    ...
    <section class="encabezado-categoria">
      <h1>Juegos de horror</h1>
      <p>Explora los mejores juegos de horror de la era retro.</p>
    </section>

    <!-- ===== LISTADO DE JUEGOS DE horror ===== -->
    <section class="juegos-categoria">
      <?php
      // Consulta personalizada: categoría "horror"
      $args = array(
        ...
        'tax_query' => array(
          array(
            ...
            'field' => 'slug',
            'terms' => 'horror', // slug de la categoría
          ),
        ),
        'posts_per_page' => -1,
      );
      ...
      <?php
        ...
        echo '<p>No se encontraron juegos de horror.</p>';
      endif;
      ?>
    </section>
